    ...
    */
    ...
    'custom' => [
        ...
        'alamat' => [
            ...
            'in' => 'ALAMAT harus diisi',
        ],
        'hobi' => [
            'required' => 'Kolom HOBI harus diisi',
            'in' => 'HOBI harus diisi',
        ],
        'quote' => [
            'required' => 'Kolom QUOTE harus diisi',
            'in' => 'QUOTE harus diisi',
        ],
        'nama_ibukandung' => [
            'required' => 'Kolom NAMA IBU KANDUNG harus diisi.',
            'string' => 'Kolom NAMA IBU KANDUNG harus berupa string',
            'max' => 'Kolom NAMA IBU KANDUNG tidak boleh lebih dari :max karakter',
        ],
        'id_kelas' => [
